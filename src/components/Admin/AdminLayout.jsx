...
const AdminLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 h-full w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 z-40 ${
        ...
        <nav className="p-4">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg mt-4 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
          >
